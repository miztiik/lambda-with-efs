...
function add_env_vars(){
    ...
    export AWS_REGION
    sudo touch /var/log/efs-performance.log
    sudo chmod 775 /var/log/efs-performance*
    sudo chown root:ssm-user /var/log/efs-performance*
}
...
"logs": {
    ...
    "files": {
        "collect_list": [
        {
            "file_path": "/var/log/efs-perf**.log",
            "log_group_name": "/miztiik-automation/efs-performance-tester",
